          ...
          <div key={step.num} className="flex items-center">
            <div className="flex flex-col items-center gap-1">
              <div className={[
                ...
                done ? 'bg-brand text-white' : active ? 'bg-brand text-white ring-4 ring-black/10' : 'bg-neutral-100 text-neutral-400',
              ].join(' ')}>
            ...
            {i < STEPS.length - 1 && (
              <div className={`h-px w-10 sm:w-16 mb-4 mx-1 transition-all duration-300 ${done ? 'bg-brand' : 'bg-neutral-200'}`} />
            )}
          </div>
        )
      })}
