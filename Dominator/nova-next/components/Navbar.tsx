    ...
    >
      <div className="max-w-[88rem] mx-auto flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2.5 group">
          ...
          <span
            className={`text-2xl font-medium tracking-tight transition-colors duration-300 ${scrolled ? 'text-black' : 'text-white'}`}
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className={`hidden md:block text-sm font-medium px-6 py-2.5 rounded-full transition-all duration-300 ${
              scrolled ? 'bg-black text-white hover:bg-black/80' : 'bg-white text-black hover:bg-white/90'
            }`}
          >
            Get Started
          </button>
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 bg-white/95 backdrop-blur-md rounded-2xl p-6 shadow-xl border border-black/5">
          <div className="flex flex-col gap-4">
            ...
            <button onClick={() => { router.push('/login'); setMenuOpen(false) }} className="mt-2 bg-black text-white text-base font-medium px-7 py-2.5 rounded-full hover:bg-black/80 transition-colors duration-200 w-full">
              Get Started
            </button>
            <button
